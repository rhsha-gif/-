...
- Open-source reuse: [evidence and licence checks](.aorch-assets/adaptive-orchestrate/references/oss.md), examples/plan-oss-adoption.json.
- Book production: [writing, editing and QA](.aorch-assets/adaptive-orchestrate/references/book.md).
- Investment research: [evidence and human decision boundaries](.aorch-assets/adaptive-orchestrate/references/investment.md).
- Academic literature: [source and MCP constraints](.aorch-assets/adaptive-orchestrate/references/papers.md).
- Refactoring: [behavior-preservation checks](.aorch-assets/adaptive-orchestrate/references/refactor.md).
- Model evaluation: [challenger evaluation](.aorch-assets/adaptive-orchestrate/references/model-upgrade.md).
